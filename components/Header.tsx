...
const Header: React.FC<HeaderProps> = ({ mode, setMode }) => {
  return (
    <header className="px-6 md:px-16 pt-12 pb-12 border-b-4 border-black bg-white relative overflow-hidden transition-colors duration-300">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-4 mb-6">
             ...
             <div className="bg-[#cc543a] text-white px-2 py-1 text-[9px] font-black uppercase tracking-widest">
                Street Letterings Archive
             </div>
          </div>
          
          <div className="flex flex-col">
            <div className="flex flex-col text-5xl md:text-8xl font-black tracking-tighter uppercase leading-[0.85]">
              <span className="text-black">Bengaluru</span>
              <span className="text-[#cc543a]">Through Your Letters</span>
            </div>
          </div>
